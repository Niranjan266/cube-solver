/*
 * min2phase - Kociemba two-phase solver, by Chen Shuang (cs0x7f).
 * Copyright (c) 2023 Chen Shuang. Used under the MIT option of its dual
 * GPLv3/MIT license (see vendor/LICENSES.md).
 *
 * Source: cubing/cubing.js src/cubing/vendor/mit/cs0x7f/min2phase/3x3x3-min2phase.js
 *         commit 805dffc66d4b696a128282d531568c5905bd071a
 *
 * Local changes, both marked "cube-solver:":
 *   1. wrapped as a classic script exposing window.min2phase, so the page
